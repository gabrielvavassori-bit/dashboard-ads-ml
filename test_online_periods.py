...
class OnlinePeriodTests(unittest.TestCase):
    ...
    def test_beta_product_diagnostics_keeps_prices_daily_history_and_read_only_preview(self):
        ...
        self.assertIn("Vendas 7d: N/D", html)
        self.assertIn("Visitas: N/D", html)
        self.assertIn("Conversão: N/D", html)
        self.assertIn("data-promo-load-scope", html)
        self.assertIn("Cada ação posterior exige uma prévia", html)
        ...
        self.assertIn("Gerar prévia de alteração", html)
        self.assertIn("Gerar prévia para sair", html)
        self.assertIn("Cada prévia e confirmação é vinculada ao MLB exibido", html)
