...
class OnlinePeriodTests(unittest.TestCase):
    ...
    def test_beta_product_diagnostics_keeps_prices_daily_history_and_read_only_preview(self):
        ...
        self.assertIn("Participar desta campanha", html)
        self.assertIn("Alterar esta promoção", html)
        self.assertIn("Sair desta promoção", html)
        self.assertIn("Etapa 1 de 2 concluída", html)
        self.assertIn("focusPromotionFeedback", html)
        self.assertIn("Nova campanha do vendedor", html)
        self.assertIn("Confirmar participação no Mercado Livre", html)
        self.assertIn("Participar desta promoção com o anúncio", html)
        self.assertIn("Oportunidades para participar", html)
        self.assertIn("Aporte Mercado Livre", html)
        self.assertIn("data-promo-action", html)
        self.assertIn("join_with_price_and_stock", html)
