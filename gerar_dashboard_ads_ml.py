  ...
  <script>
    ...
    function activateAccountDailyChart() {{
      ...
      if (!sourceRows.length) {{
        root.querySelector('.chart-summary').textContent = 'A série diária da conta ainda não está disponível';
      ...
      root.dataset.chartSeries = encodeURIComponent(JSON.stringify(sourceRows));
