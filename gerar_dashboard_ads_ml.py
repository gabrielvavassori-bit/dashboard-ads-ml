...
<head>
  ...
  <style>
    ...
    * {{ box-sizing:border-box; }}
    ...
    .detail-modal-body {{ position:relative; z-index:1; min-width:0; min-height:0; overflow:auto; overscroll-behavior:contain; padding:18px 20px 28px; }}
    ...
    @media (max-width:700px) {{ .promotion-panel-grid {{ grid-template-columns:1fr; }} .promotion-form label, .promotion-form input, .promotion-form button {{ width:100%; }} .detail-modal-backdrop {{ padding:0; }} .detail-modal-shell {{ width:100vw; height:100dvh; max-height:none; border:0; border-radius:0; }} .detail-modal-head {{ padding:12px; }} .detail-modal-tabs {{ grid-auto-flow:row; grid-template-columns:repeat(2,minmax(0,1fr)); grid-auto-columns:auto; min-height:98px; padding:8px 12px; }} .detail-modal-tabs button {{ width:100%; }} .detail-modal-body {{ padding:12px; }} .detail-modal-body .detail-grid {{ grid-template-columns:1fr; }} }}
  </style>
</head>
<body>
  <header>
